...
const DocumentRow: React.FC<Document> = ({ id, name, month, year }) => {
	...
	return (
		...
		>
			<div className={`min-w-[18rem] max-w-[18rem] h-12 mr-2 px-2 border-r-2 flex justify-start items-center`}>
				<div className={'w-full overflow-hidden'}>
					<div className={'w-[1000px]'}>{name}</div>
				</div>
			</div>
			<div className={`min-w-[12rem] max-w-[12rem] h-12 mr-2 px-2 border-r-2 flex justify-start items-center`}>
				<div className={'w-full overflow-hidden'}>
